# Traffic Spy
Provides detailed traffic analysis for selected road segments. Displays route lines color-coded by volume, a breakdown of travel purposes, and also highlights destinations.
## Features:
- Route Lines: Draws lines indicating the routes that each agent will take, similar to the vanilla system but with color-coding to indicate volume, and it works in combination with the various filters.
